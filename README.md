...
**1) Alice Obtains a Digital Certificate from a CA (Certificate Authority)**:
...
- Bobv erifies that the digital certificate is valid and has been issued by a trusted CA.
